              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Flexible(
                      child:
                          _specItem(Icons.speed, 'Transmission', 'Automatic'),
                    ),
                    const SizedBox(width: 16),
                    Flexible(
                      child: _specItem(Icons.people, 'Passengers', '4 adults'),
                    ),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    Flexible(
                      child:
                          _specItem(Icons.directions_car, 'Type', 'Hatchback'),
                    ),
                    const SizedBox(width: 16),
                    Flexible(
                      child:
                          _specItem(Icons.local_gas_station, 'Fuel', 'Petrol'),
                    ),
                  ],
                ),
